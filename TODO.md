# TODO: Make Mentor Blog Page Responsive

## Tasks
- [x] Optimize mentor_sidebar.html for better mobile experience (e.g., adjust width, padding, toggle behavior)
- [x] Update main content padding in blog.html to be responsive (p-4 on mobile, p-8 on desktop)
- [x] Make header buttons stack vertically on mobile in blog.html
